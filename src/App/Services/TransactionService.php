...
class TransactionService
{
    ...
    public function getUserTransactions(int $length, int $offset)
    {
        ...
        $transactions = $this->db->query("SELECT *, DATE_FORMAT(date, '%Y-%m-%d') as formatted_date FROM transactions WHERE user_id = :user_id AND description LIKE :description LIMIT {$length} OFFSET {$offset}", $params)->findAll();
